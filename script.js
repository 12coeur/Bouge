console.log("🆕🆕🆕 VERSION 2.1 - script.js CHARGÉE 🆕🆕🆕");
...
// =======================================================
// GESTION DE LA DISPARITION DES MENUS APRÈS INACTIVITÉ
// =======================================================
...
function displayTrace(traceData) {
  ...
  // Affichage de la trace (ligne bleue)
  if (document.getElementById('traceCheckbox').checked) {
    ...
    console.log('📈 Trace affichée');
  }

  // Création de l'entité mobile (avion/modèle)
